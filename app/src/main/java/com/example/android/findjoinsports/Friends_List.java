...
//                                String time = object.getString("time");
                            ...
                            Adapter_List_Friends adapter_list_friends = new Adapter_List_Friends(Friends_List.this, list_friendDataList, new Adapter_List_Friends.OnItemClickListener() {
                                ...
                                @Override
                                public void onItemClick(int user_id) {
                                    Intent intent = new Intent(Friends_List.this,DetailsActivity.class);
                                    intent.putExtra("user_id",user_id);
                                    //     Toast.makeText(Friends_List.this, user_id, Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_back:
                ...
                Intent back = new Intent(Friends_List.this, NavDrawer.class);
                startActivity(back);
