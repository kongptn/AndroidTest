...
public class SearchFootball extends AppCompatActivity {

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_PRODUCTS = "http://192.168.2.37/findjoinsport/search_activity/api.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_PRODUCTS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Adapter adapter = new Adapter(SearchFootball.this, recyclerSearchList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SearchFootball.this, error.getMessage(), Toast.LENGTH_SHORT).show();
