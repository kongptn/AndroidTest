<?php 
	...
	*/
	...
	INNER JOIN users u ON rf.user_id = u.user_id INNER JOIN status s ON rf.status_id = s.status_id WHERE rf.status_id = 'F02' AND rf.userid_add = 35 AND rf.user_id != 36");
