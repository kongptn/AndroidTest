<?php 
	...
	*/
	...
	$stmt = $conn->prepare("SELECT a.id , a.stadium_name , a.description , a.photo , a.date , a.time , a.location , a.number_join , u.user_id , u.name , u.photo_user FROM activity a INNER JOIN users u on a.user_id = u.user_id WHERE a.user_id = '$user_id'");
