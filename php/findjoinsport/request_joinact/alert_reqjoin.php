<?php 
	...
	*/
	...
	FROM request_joinact rq INNER JOIN football_activity a on rq.id = a.id INNER JOIN status s on rq.status_id = s.status_id INNER JOIN users u on rq.userid_join = u.user_id WHERE rq.user_create = '$userid_join'");
